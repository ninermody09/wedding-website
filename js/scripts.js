$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        var four_invite = ["Dilip Kuntawala", "Deepak Mody", "Sanjay Patel", "Komal Desai", "Komal Parikh", "Trupti Desai", "Kenny Desai", "Mukesh Patel", "Alpesh Patel", "Vikash Patel", "Nikki Patel", "Vanita Kuntawala", "Rashmi Patel", "Anju Patel", "Nilam Patel", "Ayushi Patel", "Reena Patel", "Henita Kuntawala", "Alisha Patel", "Myan Patel", "Layla Patel", "Kairav Patel", "Aidan Patel", "Shreya Kuntawala", "Alaina Patel", "Dylan Patel", "Skyler Patel", "Akira Patel", "Laila Patel"];
